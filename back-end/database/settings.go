...
func (d *DB) SetFightcadePassword(v string) error {
	return d.setEncryptedSetting("fightcade.password", v)
}

func (d *DB) FightcadeMatchDuration() (string, error) { return d.getSetting("fightcade.matchDuration") }
func (d *DB) SetFightcadeMatchDuration(v string) error {
...
func (d *DB) RealesrganPath() (string, error)  { return d.getSetting("realesrgan.path") }
func (d *DB) SetRealesrganPath(v string) error { return d.setSetting("realesrgan.path", v) }
